...
function SuccessInner() {
 ...
 <div className="flex-1 bg-secondary px-4 py-10 sm:px-12 flex flex-col items-center justify-start text-center">
  ...
  <p className="text-base sm:text-lg leading-relaxed">
    გმადლობთ! თქვენი დოკუმენტები წარმატებით იქნა მიღებული და დამუშავების პროცესშია.
    საჭიროების შემთხვევაში, დამატებითი დეტალებისთვის ჩვენ დაგიკავშირდებით.<br /><br />
