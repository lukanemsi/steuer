  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-primary text-black">
      ...
      <main className="flex-1 bg-secondary px-4 py-6 sm:px-12 sm:py-10 flex flex-col items-center justify-start">
       ...
       <p>
  <strong>StudentSteuer.ge</strong> არის პირველი ქართული კომპანია, რომელიც ქართველ სტუდენტებს <strong>გერმანული გადასახადის “შთოიერის”</strong> დაბრუნებას ონლაინ 
  რეჟიმში სთავაზობს. სერვისის ღირებულება შეადგენს სტანდარტულ 50€-ს, რაც უზრუნველყოფს სტუდენტის დოკუმენტების ნოტარიულ დამოწმებას 
  და საფოსტო მომსახურების ხარჯების დაფარვას. მეტი ინფორმაციისთვის გთხოვთ რომ გაეცნოთ ჩვენს მომსახურების პირობებს.
  Studentsteuer-ის გუნდი მზად არის დაგეხმაროთ. 
  გთხოვთ კითხვების შემთხვევაში <strong>დაგვიკავშირდეთ: 557154266 ან studentsteuer@gmail.com</strong>
</p>
